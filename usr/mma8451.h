...
#define MMA_SCL_L()     (GPIOA->BRR = GPIO_Pin_7)
#define MMA_SCL_H()     (GPIOA->BSRR = GPIO_Pin_7)
#define MMA_SDA_L()     (GPIOA->BRR = GPIO_Pin_6)
#define MMA_SDA_H()     (GPIOA->BSRR = GPIO_Pin_6)

#define MMA_SDA_IN()    GPIOA->MODER &= 0xffffcfff
#define MMA_SDA_OUT()   GPIOA->MODER &= 0xffffcfff; GPIOA->MODER |= 0x0000d000

#define MMA_SDA_READ()  (GPIOA->IDR & GPIO_Pin_6)

#define NACK  0             //用于判断是否结束通讯 
#define ACK   1             //结束数据传输 
